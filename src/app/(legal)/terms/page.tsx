    ...
    <article className="prose-legal">
      ...
      <div className="space-y-8 text-[#0A0A0A]/80" style={{ fontFamily: "var(--font-body)" }}>
        ...
        <section>
          ...
          <h3 className="text-base font-semibold text-[#0A0A0A] mb-2">Your Content</h3>
          ...
          <h3 className="text-base font-semibold text-[#0A0A0A] mb-2">AI-Generated Content</h3>
          <p className="leading-relaxed mb-3">
          ...
          <h3 className="text-base font-semibold text-[#0A0A0A] mb-2">Ghost Rooms</h3>
          <p className="leading-relaxed">
