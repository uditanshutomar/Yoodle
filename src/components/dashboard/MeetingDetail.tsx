...
export default function MeetingDetail({
    ...
    return (
        ...
        >
            {/* Backdrop */}
            <div className="absolute inset-0 bg-[#0A0A0A]/30 backdrop-blur-sm" onClick={onClose} />
            ...
            <motion.div
                ...
                className="relative ml-auto flex h-full w-full max-w-[960px] flex-col bg-[#FAFAF8] border-l-2 border-[#0A0A0A] shadow-2xl"
            >
                {/* ── HEADER ── */}
                <div className="flex-shrink-0 border-b-2 border-[#0A0A0A]/15 bg-white px-8 py-5">
                    <div className="flex items-start justify-between">
                        <div className="flex-1">
                            ...
                            <div className="flex items-center gap-3 mb-2">
                                <motion.button
                                    ...
                                    whileTap={{ scale: 0.9 }}
                                    onClick={onClose}
                                    className="flex h-8 w-8 items-center justify-center rounded-full border-[1.5px] border-[#0A0A0A]/20 text-[#0A0A0A]/50 hover:bg-[#FFE600]/20 hover:border-[#0A0A0A]/40 transition-colors"
                                >
                                ...
                                <div>
                                    ...
                                    <div className="flex items-center gap-2 mt-0.5">
                                        <span className="text-xs text-[#0A0A0A]/40">{meeting.date} · {meeting.time}</span>
                                        <span className="text-[#0A0A0A]/15">·</span>
                                        <span className="text-xs text-[#0A0A0A]/30">{meeting.duration}</span>
                                        <span className="text-[#0A0A0A]/15">·</span>
                                        <span className="text-xs text-[#0A0A0A]/30">{meeting.roomType}</span>
                                    </div>
                                </div>
                            </div>
                            ...
                            <div className="flex items-center gap-2 mt-3">
                                {meeting.avatars.map((a, i) => (
                                    <div key={i} className="flex items-center gap-1.5 rounded-full bg-[#0A0A0A]/[0.03] px-2 py-1">
                                        <div className="relative h-5 w-5 rounded-full overflow-hidden border border-white">
                                            <Image src={a.src} alt={a.name} fill className="object-cover" sizes="20px" />
                                        </div>
                                        <span className="text-[11px] font-medium text-[#0A0A0A]/60">{a.name}</span>
                                        {a.role && <span className="text-[9px] text-[#0A0A0A]/25">{a.role}</span>}
                                    </div>
                                ))}
                            </div>
                        </div>
                        ...
                        <div className="flex items-center gap-2 mt-1">
                            ...
                            <button className="flex items-center gap-1.5 rounded-full border-[1.5px] border-[#0A0A0A]/20 px-3 py-1.5 text-[11px] font-bold text-[#0A0A0A]/50 hover:bg-[#FFE600]/20 hover:border-[#0A0A0A]/40 transition-colors" style={{ fontFamily: "var(--font-heading)" }}>
                ...
                {/* ── TABS ── */}
                <div className="flex-shrink-0 bg-white border-b-2 border-[#0A0A0A]/15 px-8">
                            ...
                            return (
                                <button
                                    ...
                                    className={`flex items-center gap-1.5 px-4 py-3 text-xs font-semibold border-b-2 transition-all ${tab === t.key
                                        ...
                                        : disabled
                                            ? "border-transparent text-[#0A0A0A]/15 cursor-not-allowed"
                                            : "border-transparent text-[#0A0A0A]/35 hover:text-[#0A0A0A]/60"
                                        }`}
                                    style={{ fontFamily: "var(--font-heading)" }}
                                >
                ...
                <div className="flex-1 flex overflow-hidden">
                    ...
                    {/* Action sidebar */}
                    <div className="w-[220px] flex-shrink-0 border-l-2 border-[#0A0A0A]/15 bg-white p-5 overflow-y-auto">
                        <p className="text-[10px] font-bold text-[#0A0A0A]/25 uppercase tracking-wider mb-3" style={{ fontFamily: "var(--font-heading)" }}>
                            Quick actions
                        </p>
                            ...
                            {[
                                ...
                                <motion.button
                                    ...
                                    className={`flex items-center gap-2.5 w-full rounded-xl px-3 py-2.5 text-left text-xs font-medium transition-all ${action.available
                                        ? "text-[#0A0A0A]/60 hover:bg-[#0A0A0A]/[0.03] hover:text-[#0A0A0A]/80 cursor-pointer"
                            ...
                            <div className="mt-6">
                                ...
                                <div className="space-y-2">
                                    {meeting.mom.actionItems.map((item, i) => (
                                        <div key={i} className="rounded-lg border-[1.5px] border-[#0A0A0A]/15 p-2.5">
                                            <p className="text-[11px] font-medium text-[#0A0A0A]/70 leading-snug mb-1">{item.task}</p>
                                            <div className="flex items-center justify-between">
                                                <span className="text-[9px] text-[#0A0A0A]/30 font-medium">{item.owner}</span>
            ...
            {meeting.overview && (
                <div className="space-y-5">
                    ...
                    {meeting.overview.nextMeeting && (
                        <div className="rounded-2xl border-[1.5px] border-[#0A0A0A]/15 bg-white p-4">
                            <p className="text-[10px] font-bold text-[#0A0A0A]/25 uppercase tracking-wider mb-1.5" style={{ fontFamily: "var(--font-heading)" }}>Next meeting</p>
                            <p className="text-sm text-[#0A0A0A]/70 flex items-center gap-2">
                    ...
                    <div className="grid grid-cols-3 gap-3">
                        {[
                            ...
                            <div key={stat.label} className="rounded-2xl border-[1.5px] border-[#0A0A0A]/15 bg-white p-4 text-center">
                                <span className="mb-1 block">{stat.icon}</span>
                                <p className="text-lg font-bold text-[#0A0A0A]" style={{ fontFamily: "var(--font-heading)" }}>{stat.value}</p>
                                <p className="text-[10px] text-[#0A0A0A]/30 font-medium">{stat.label}</p>
                            </div>
                        ))}
                    </div>
                </div>
...
function MoMTab({ meeting }: { meeting: MeetingRecord }) {
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-5">
            {/* Key decisions */}
            <div className="rounded-2xl border-[1.5px] border-[#0A0A0A]/15 bg-white p-5">
                <p className="text-[10px] font-bold text-[#0A0A0A]/25 uppercase tracking-wider mb-3 flex items-center gap-1.5" style={{ fontFamily: "var(--font-heading)" }}><svg width="12" height="12" viewBox="0 0 24 24" fill="none" stroke="#EF4444" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><circle cx="12" cy="12" r="10" /><circle cx="12" cy="12" r="6" /><circle cx="12" cy="12" r="2" /></svg> Key decisions</p>
                <ul className="space-y-2">
                    {mom.keyDecisions.map((d, i) => (
                        <li key={i} className="flex items-start gap-2.5 text-sm text-[#0A0A0A]/70 leading-relaxed">
            ...
            <div className="rounded-2xl border-[1.5px] border-[#0A0A0A]/15 bg-white p-5">
                ...
                <ul className="space-y-2">
                    {mom.discussionPoints.map((d, i) => (
                        <li key={i} className="flex items-start gap-2.5 text-sm text-[#0A0A0A]/60 leading-relaxed">
            ...
            <div className="rounded-2xl border-[1.5px] border-[#0A0A0A]/15 bg-white p-5">
                ...
                <div className="space-y-2">
                    {mom.actionItems.map((item, i) => (
                        <div key={i} className="flex items-center justify-between rounded-xl bg-[#FAFAF8] px-3.5 py-2.5">
                            <div className="flex items-center gap-2.5">
                                <span className="flex h-4 w-4 items-center justify-center rounded border border-[#0A0A0A]/15 text-[8px]" />
                                <span className="text-sm text-[#0A0A0A]/70">{item.task}</span>
                            </div>
                            <div className="flex items-center gap-3">
                                <span className="text-[10px] font-medium text-[#0A0A0A]/40">{item.owner}</span>
...
function TranscriptTab({ meeting, searchQuery, setSearchQuery }: { meeting: MeetingRecord; searchQuery: string; setSearchQuery: (q: string) => void }) {
    ...
    return (
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }}>
            {/* Search */}
            <div className="mb-4 flex items-center gap-2 rounded-xl border-[1.5px] border-[#0A0A0A]/20 bg-white px-3 py-2.5">
                <svg width="13" height="13" viewBox="0 0 24 24" fill="none" stroke="#0A0A0A" strokeOpacity="0.3" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><circle cx="11" cy="11" r="8" /><line x1="21" y1="21" x2="16.65" y2="16.65" /></svg>
                <input
                    type="text"
                    value={searchQuery}
                    onChange={(e) => setSearchQuery(e.target.value)}
                    placeholder="Search transcript..."
                    className="flex-1 bg-transparent text-sm outline-none placeholder:text-[#0A0A0A]/20"
                    style={{ fontFamily: "var(--font-body)" }}
                />
                {searchQuery && (
                    <button onClick={() => setSearchQuery("")} className="text-[10px] text-[#0A0A0A]/30 hover:text-[#0A0A0A]/50">Clear</button>
                )}
            </div>
            ...
            <div className="space-y-1">
                {filtered.map((entry, i) => (
                    <motion.div
                        ...
                        className="flex gap-3 rounded-xl px-3 py-2.5 hover:bg-white transition-colors group"
                    >
                        <span className="flex-shrink-0 text-[10px] text-[#0A0A0A]/20 font-mono pt-0.5 w-8">{entry.time}</span>
                        <div className="flex-1">
                            <span className="text-[11px] font-bold text-[#0A0A0A]/50 mr-2" style={{ fontFamily: "var(--font-heading)" }}>{entry.speaker}</span>
                            <span className="text-sm text-[#0A0A0A]/65 leading-relaxed">{entry.text}</span>
                        </div>
                    </motion.div>
                ))}
            </div>
...
function RecordingTab({ meeting }: { meeting: MeetingRecord }) {
    return (
        <motion.div initial={{ opacity: 0, y: 10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="space-y-5">
            {/* Video preview */}
            <div className="rounded-2xl border-[1.5px] border-[#0A0A0A]/15 bg-[#0A0A0A] overflow-hidden relative" style={{ aspectRatio: "16/9" }}>
                ...
                <div className="absolute inset-0 flex items-center justify-center">
                    ...
                    >
                        <svg width="24" height="24" viewBox="0 0 24 24" fill="#0A0A0A"><polygon points="5 3 19 12 5 21 5 3" /></svg>
                    </motion.button>
                </div>
                {/* Progress bar */}
            ...
            {/* Controls */}
            <div className="flex items-center justify-between rounded-2xl border-[1.5px] border-[#0A0A0A]/15 bg-white p-4">
                <div className="flex items-center gap-4">
                    <button className="text-[#0A0A0A]/40 hover:text-[#0A0A0A]/60 transition-colors">
                    ...
                    <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }}
                        className="flex h-10 w-10 items-center justify-center rounded-full bg-[#0A0A0A] text-white">
                ...
                <span className="text-xs text-[#0A0A0A]/30 font-mono">15:42 / {meeting.duration}</span>
                <div className="flex items-center gap-2">
                    <button className="text-[10px] font-bold text-[#0A0A0A]/30 hover:text-[#0A0A0A]/50 px-2 py-1 rounded-lg hover:bg-[#0A0A0A]/5 transition-colors" style={{ fontFamily: "var(--font-heading)" }}>1x</button>
                    <button className="text-[#0A0A0A]/30 hover:text-[#0A0A0A]/50 transition-colors">
                ...
                <div className="space-y-2">
                    {[
                        ...
                        <motion.button
                            key={i}
                            whileHover={{ x: 2 }}
                            className="flex items-center gap-3 w-full rounded-lg px-3 py-2 text-left hover:bg-[#FAFAF8] transition-colors"
                        >
                            <span className="text-[10px] text-[#0A0A0A]/25 font-mono w-8">{m.time}</span>
                            <span className="text-xs text-[#0A0A0A]/60">{m.label}</span>
                        </motion.button>
                    ))}
                </div>
            </div>
...
function Section({ title, content }: { title: string; content: string }) {
    return (
        <div className="rounded-2xl border-[1.5px] border-[#0A0A0A]/15 bg-white p-5">
            <p className="text-[10px] font-bold text-[#0A0A0A]/25 uppercase tracking-wider mb-2" style={{ fontFamily: "var(--font-heading)" }}>{title}</p>
            <p className="text-sm text-[#0A0A0A]/65 leading-relaxed">{content}</p>
        </div>
    );
}
