  ...
  return (
    <AnimatePresence>
      {isDisconnected && (
        ...
        >
          <motion.div
            className="rounded-2xl border-2 border-[#0A0A0A] bg-white p-8 shadow-[6px_6px_0_#0A0A0A] max-w-sm w-full mx-4 text-center"
          ...
          >
            {isFailed ? (
              <>
                ...
                <div className="flex items-center justify-center w-16 h-16 mx-auto rounded-2xl border-2 border-[#0A0A0A] bg-[#FF6B6B] shadow-[3px_3px_0_#0A0A0A] mb-4">
                ...
                <motion.button
                  className="w-full py-3 rounded-xl border-2 border-[#0A0A0A] bg-[#FF6B6B] text-white font-bold shadow-[3px_3px_0_#0A0A0A] cursor-pointer flex items-center justify-center gap-2"
                  style={{ fontFamily: "var(--font-heading)" }}
              ...
              <>
                {/* Reconnecting */}
                <div className="flex items-center justify-center w-16 h-16 mx-auto rounded-2xl border-2 border-[#0A0A0A] bg-[#FFE600] shadow-[3px_3px_0_#0A0A0A] mb-4">
                  <motion.div
                    animate={{ rotate: 360 }}
                ...
                <div className="flex items-center justify-center gap-1 mb-6">
                  {Array.from({ length: maxAttempts }).map((_, i) => (
                    <div
                      key={i}
                      className={`h-2 w-2 rounded-full border border-[#0A0A0A]/20 ${
                        i < attemptCount
                          ? "bg-[#FFE600]"
                          : "bg-[#0A0A0A]/10"
                      }`}
