      ...
      <div className="relative flex items-center justify-between">
        <div className="flex items-center gap-3">
          <motion.div
            ...
            className="flex h-10 w-10 items-center justify-center rounded-full bg-[#7C3AED] border-2 border-[#0A0A0A]"
          >
            <Ghost size={20} className="text-white" />
          </motion.div>
          <div>
            <div className="flex items-center gap-2">
              <h2 className="text-base font-bold text-[#0A0A0A]" style={{ fontFamily: "var(--font-heading)" }}>
                {title}
              </h2>
            ...
            <p className="flex items-center gap-1 text-xs text-[#0A0A0A]/50" style={{ fontFamily: "var(--font-body)" }}>
